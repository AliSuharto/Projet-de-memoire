...
const MarketsManagement: React.FC = () => {
  ...
  const handleViewMarket = (marketId: number) => {
    window.location.href = `/dashboard/regisseur/marches/${marketId}`;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-6 lg:p-0 pt-20 md:pt-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2">{totalMarkets}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2">{totalPlaces}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2">{avgOccupation}%</p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {/* En-tête du tableau avec recherche sur la même ligne */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-gray-50 border-b border-gray-200 px-4 sm:px-6 py-4">
                  ...
                  <tr>
                    <td colSpan={6} className="px-4 sm:px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-600 text-sm sm:text-base">Chargement des marchés...</p>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={6} className="px-4 sm:px-6 py-12 text-center">
                      <div className="text-gray-500">
                        ...
                        <p className="font-medium text-sm sm:text-base">Aucun marché trouvé</p>
                  ...
                  filteredMarkets.map((market) => (
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-4">
                        <div>
                          <div className="font-semibold text-gray-900 text-sm sm:text-base">{market.nom}</div>
                          <div className="text-xs sm:text-sm text-gray-600 flex items-center gap-1 mt-1">
                            <MapPin className="w-3 h-3 flex-shrink-0" />
                            <span className="truncate">{market.adresse}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 sm:px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center w-12 sm:w-16 h-7 sm:h-8 bg-blue-50 text-blue-700 font-semibold rounded-md text-xs sm:text-sm">
                          {market.totalPlaces}
                        </span>
                      </td>
                      <td className="px-4 sm:px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center w-12 sm:w-16 h-7 sm:h-8 bg-gray-50 text-gray-700 font-semibold rounded-md text-xs sm:text-sm">
                          {market.placesOccupees}
                        </span>
                      </td>
                      <td className="px-4 sm:px-6 py-4 text-center">
                        <div className={`inline-flex items-center px-2 sm:px-3 py-1 rounded-full border ${getOccupationColor(market.tauxOccupation)} ${getOccupationBorderColor(market.tauxOccupation)}`}>
